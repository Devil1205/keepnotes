    ...
    return (
        <div className='container my-4'>
            ...
            <div className="container d-flex my-4">
                <button className='btn btn-success' disabled={props.page===0} onClick={prevClick}>Previous</button>
                <button className='btn btn-success' disabled={Math.floor((Object.keys(JSON.parse(localStorage.getItem('note'))).length-1)/6)===props.page} onClick={nextClick} style={{ marginLeft: "auto" }}>Next</button>
            </div>
        </div>
    )
}
